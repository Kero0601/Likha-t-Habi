...
const ShopPage = () => {
  ...
  // Fetch fresh data & reset filters when entering page
  useEffect(() => {
                  ...
                  <div className="image-wrapper">
                    ...
                    <button 
                      ...
                      onClick={(e) => { 
                          ...
                          // FIX: Added toastId to prevent wishlist spam
                          if(!isLiked) toast.success("Added to Wishlist! ❤️", { toastId: `wish-${productId}` });
                      }}
                    >
                      {isLiked ? '♥' : '♡'}
                    </button>
                  ...
                  <div className="card-info">
                    ...
                    <div className="price-row">
                      ...
                      <button 
                        ...
                        onClick={(e) => {
                            e.preventDefault(); 
                            // FIX: Only call addToCart. ShopContext handles the success toast now.
                            if (!isOutOfStock) {
                                addToCart(product);
                            }
                        }}
